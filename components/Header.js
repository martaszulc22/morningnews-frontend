...
function Header() {
	...
	const handleShowHiddenArticles = () => {
		dispatch(unhideArticles());
	}

	const handleRegister = () => {
		fetch('https://morningnews-backend-red.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-red.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	if (user.token) {
		userSection = (
			<div className={styles.logoutSection}>
				<FontAwesomeIcon onClick={() => handleShowHiddenArticles()} icon={faEye} className={styles.showHiddenIcon} />
